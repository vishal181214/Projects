...
import imageOne from '../img/imgThree.jpg'
import imageTwo from '../img/imgOne.jpg'
import imageFour from '../img/NatureOne.webp'
import natureTemp from '../img/NatureTemp.jpg'

export function HomeImageTwo() {
    return (
