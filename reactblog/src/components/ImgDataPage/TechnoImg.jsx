...
import imageOne from '../img/TechnoThree.jpg'
import imageTwo from '../img/imgTechFour.jpg'
import imageFour from '../img/imgTech.webp'
import natureTemp from '../img/technoFour.webp'
import imageFive from '../img/technoFive.jpg'

//imageOne
export function TechnoImgFirst() {
    return (
...
//natureTemp
export  function TechnoImgThree() {
    return (
        <contextData.Consumer>
            {(props) => {
                return (
                    ...
                    <>
                        ...
                        <div className="imageContent">
                            ...
                            <div className="imageDataInfo">
                                ...
                                <div className="reactImage"><img src={imageFour}/></div>
                                <div className="contImg">
                                    <p>{props.contImgText}</p><br/>
                                    <p>{props.contImgText}</p>
                                    <p style={{marginTop:'5vh'}}>{props.talk}</p>
                                </div>
                                <div className="codeImg"><img src={imageFour}/></div>
                                <div className="Rjava">
                                    <div className="lang"><p>{props.react}</p></div>
                                    <div className="lang"><p>{props.js}</p></div>
                                    <div className="lang"><p>{props.ani}</p></div>
                        ...
                        <div className="footer">
                            ...
                            <div className="userCards">
                                <div className="userCared">
                                    <p className='taggedText'>{props.tagged}</p>
                                    <div className="authImage"><img src={imageFour}/></div>
                                    <p className='Joshua'>{props.authText}</p>
                                    <div className="authInfoCard">
                                        <div className="Authpic"></div>
                                        <div className="picInfo">
                    ...
                    <>
                        ...
                        <div className="imageContent">
                            ...
                            <div className="imageDataInfo">
                                ...
                                <div className="reactImage"><img src={imageFive}/></div>
                                <div className="contImg">
                                    <p>{props.contImgText}</p><br/>
                                    <p>{props.contImgText}</p>
                                    <p style={{marginTop:'5vh'}}>{props.talk}</p>
                                </div>
                                <div className="codeImg"><img src={imageFive}/></div>
                                <div className="Rjava">
                                    <div className="lang"><p>{props.react}</p></div>
                                    <div className="lang"><p>{props.js}</p></div>
                                    <div className="lang"><p>{props.ani}</p></div>
                        ...
                        <div className="footer">
                            ...
                            <div className="userCards">
                                <div className="userCared">
                                    <p className='taggedText'>{props.tagged}</p>
                                    <div className="authImage"><img src={imageFive}/></div>
                                    <p className='Joshua'>{props.authText}</p>
                                    <div className="authInfoCard">
                                        <div className="Authpic"></div>
                                        <div className="picInfo">
